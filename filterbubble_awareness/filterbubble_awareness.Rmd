...
plot_data %>% 
  ...
  labs(x="Variables", y="Mean of Scale (1-6)", 
       title="Most user have heard of the filter bubble",
       subtitle = "Different measures of Filter buble awareness",
       caption = "Errorbar denots the 95% confidence intervall of the mean.") +
  guides(fill = FALSE) +
  coord_flip() +
